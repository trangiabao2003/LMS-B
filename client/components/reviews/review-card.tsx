...
const ReviewCard = (props: Props) => {
    return (
        <div className="w-full h-max pb-4 dark:bg-slate-800 dark:bg-opacity-[0.20] border border-[#00000028] dark:border-[#ffffff1d] backdrop-blur shadow-[bg-slate-800] rounded-[10px] p-4 cursor-pointer hover:shadow-lg transition-all duration-300">
